...
public class InsertResult extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            int year = new Integer((String)session.getAttribute("year")).intValue();
            int month = new Integer((String)session.getAttribute("month")).intValue();
            int day = new Integer((String)session.getAttribute("day")).intValue();
            ...
            e.printStackTrace();//デバックするときはチェックをしてあげる。
