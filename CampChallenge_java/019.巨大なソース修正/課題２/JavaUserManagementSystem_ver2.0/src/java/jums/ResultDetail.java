...
public class ResultDetail extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            HttpSession resultSession = request.getSession();//このsessionは今後削除などで使う
            
            //jspから詳細を見たいデータのidを受け取る
            String resultId = request.getParameter("id");
            int i = 0;
            //検索結果のページの場合はidがある。後ほど検証するために型変換を行う。
            if (resultId != null) {
                i = Integer.parseInt(resultId);
            } else if (resultId == null) {
                i = (Integer) resultSession.getAttribute("id");
            }
