<%-- 
    Document   : vender
    Created on : 2017/08/22, 17:51:53
    Author     : sasakichiaki
--%>
...
<html>
    ...
    <head>
        ...
        <link href="css/sp.css" rel="stylesheet" type="text/css" media="only screen and (max-width : 720px)">
        <link href="css/lndex.css" rel="stylesheet" type="text/css" media="screen">
    </head>
            ...
            <header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
                <div class="mdl-layout__header-row">
                    ...
                    <ul class="mdl-menu mdl-js-menu mdl-js-ripple-effect mdl-menu--bottom-right" for="hdrbtn">
                        <li class="mdl-menu__item">ログアウト</li>
                    </ul>
                </div>
            </header>
            <!-- ユーザーメニュー-->
