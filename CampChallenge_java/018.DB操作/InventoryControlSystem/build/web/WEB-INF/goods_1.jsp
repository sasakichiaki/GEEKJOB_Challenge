		...
		<tr>
			...
			<th>janCode </th>
                        ...
                        <%
                            ...
                            for(int i = 0; i < n; i++){
                               out.print("<tr>");
                               out.print("<td>"+session.getAttribute("DataId"+i)+"</td>");
                               out.print("<td>"+session.getAttribute("DataName"+i)+"</td>");
                               out.print("<td>"+session.getAttribute("DataPrice"+i)+"</td>");
                               out.print("<td>"+session.getAttribute("DataStock"+i)+"</td>");
                               out.print("<td>"+session.getAttribute("DataDesription"+i)+"</td>");
                               out.print("<td>"+session.getAttribute("DataJanCode"+i)+"</td>");
                               out.print("</tr>");
                            }      
