        ...
        <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
            ...
            <div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
                ...
                <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
                    ...
                    <a class="mdl-navigation__link" href="UserAdd?action=click"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation"><i class="fa fa-id-card-o" aria-hidden="true"></i></i>ユーザー一覧</a>
            ...
            <p class=userForm>名前:<input type="text" name="goodsName" size="20" maxlength="20"></p>
            <p class=userForm>価格（税別）:<input type="number" name="price" size="20" maxlength="20"></p>
            <p class=userForm>在庫:<input type="number" name="stock" size="20" maxlength="20"></p>
            <p class=userForm>商品説明:<input type="text" name="description" size="20" maxlength="20"></p>
            <p class=userForm>janCode:<input type="number" name="janCode" size="20" maxlength="20"></p>
